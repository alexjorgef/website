...
describe(`bandcamp-scraper`, function () {
  ...
  describe(`getAlbumUrls`, function () {
    it(`scrape album urls`, function (done) {
      ...
      expect(
        bandcamp.getAlbumUrls(artistUrl, function (error, albumUrlsCb) {
          // console.log(`artistUrl`, artistUrl)
          // if (error) console.log(`error`, error)
          // if (albumUrlsCb) console.log(`albumUrlsCb`, albumUrlsCb)
          expect(error).toBeNull()
          expect(Array.isArray(albumUrlsCb)).toBe(true)
          expect(albumUrlsCb.length).toBeGreaterThan(0)
          done()
          // TODO validate with JSON schema
        })
      )
