          ...
          <Stack spacing="20" align="center">
            <Stack spacing="3" align="center">
              ...
              <Text variant="prominent" maxWidth="45ch" textAlign="center">
                This is part of my music wishlist. Feel free to visit
                my
                {` `}
                <ExternalLink href="https://bandcamp.com/alexjorgef" isExternal={true}>profile</ExternalLink> and check more.
              </Text>
            </Stack>
            <Grid
            ...
            >
              {wishlist.nodes.map((wishlist) => {
                return (
                  <Container key={wishlist.id}>
                    <ExternalLink href={wishlist.url} isExternal={true}>
                      <Image
                        borderRadius="lg"
                        src={wishlist.img}
                        alt={wishlist.title}
